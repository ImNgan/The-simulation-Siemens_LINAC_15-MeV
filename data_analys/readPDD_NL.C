...
using namespace std;
	///FUNCTION: CHUAN PDD /////
void PDD(TH1F *histo,TH1F *h1,TH1F *h2){
double dose=0.;
int bin;
...
///////NANG LUONG 145 MeV///////
TFile *PDD_1ti145 = TFile::Open("2ti_145r.root");
...
///////NANG LUONG 15 MeV///////
TFile *PDD_1ti15 = TFile::Open("2ti_15r_4.root");
...
//chugiai.AddEntry ( h8 , " 15 MeV " ) ;
//chugiai.AddEntry ( h6 , " 14.5 MeV " ) ;
